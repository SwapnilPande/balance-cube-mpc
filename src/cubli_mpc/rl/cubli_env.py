...
class RewardConfig:
    """Quadratic-form cost weights. Defaults give the balance error
    dominant authority while gently regularizing wheel speed + torque.
    """
...
class EnvConfig:
    ...
    fall_tilt_rad: float = math.radians(60.0)
